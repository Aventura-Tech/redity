...
describe('Blockcode: Console', () => {
  // it('Console norm and info', () => {
  //   const spy = jest.spyOn(Log, 'info')
  //   const spy2 = jest.spyOn(Log, 'norm')
  //   const blockCode = new BlockCode()
  //   blockCode.start()
  //   blockCode.block('A block')
  //   blockCode.block('A block')
  //   blockCode.end()
  ...
  it('Console error and resolve', () => {
    const spy = jest.spyOn(Log, 'error')
    const spy2 = jest.spyOn(Log, 'warn')
    const blockCode = new BlockCode()
    blockCode.start()
    blockCode.block('A block')
    blockCode.catch()
    ...
    blockCode.block('Other block')
    blockCode.catch()
    blockCode.block('Last Block hehe')
    expect(spy).toHaveBeenCalledTimes(2)
    spy.mockRestore()
  ...
  // it('Console Hide and Unhide', () => {
  //   const spy = jest.spyOn(Log, 'info')
  //   const spy2 = jest.spyOn(Log, 'norm')
  //   const blockCode = new BlockCode()
  //   blockCode.hide()
  //   blockCode.start()
  //   blockCode.block('[Hide] block ========================> 01')
  //   blockCode.block('[Hide] Other block ==================> 02')
  //   blockCode.unhide()
  //   blockCode.block('[Unhide] block again ================> 03')
  //   blockCode.hide()
  //   blockCode.block('[Hide] Last block again hehe ========> 04')
  //   blockCode.unhide()
  //   blockCode.end()
  ...
  it('Mode dev false', () => {
    ...
    blockCode.block('[Hide] Other block ==================> 02')
    blockCode.unhide()
    blockCode.block('[Hide] block again ==================> 03')
    blockCode.hide()
    blockCode.block('[Hide] Last block again hehe ========> 04')
    blockCode.unhide()
    blockCode.end()
