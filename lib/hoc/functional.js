...
function _default(keyModel) {
  ...
  return function (Component) {
    ...
    return function Wrapper(props) {
      var isDone = false; // eslint-disable-next-line camelcase
      ...
      var _React$useState = _react["default"].useState({
        ...
        date: Date.now()
          ...
          current_states = _React$useState2[0],
          nextDefinedToProps = _React$useState2[1]; // ====================================== //
      ...
      function componentWillMount() {
        ...
        subscriber.onListen = function (states) {
          statesDefinedToProps = _objectSpread({}, statesDefinedToProps, {}, states);
          nextDefinedToProps({
            date: Date.now(),
            states: states
          });
      ...
      subscriber.setProps(props); // statesDefinedToProps = subscriber.getStatesDefined()
      ...
      return _react["default"].createElement(Component, (0, _extends2["default"])({}, dispatchersDefined, statesDefinedToProps, current_states.states, props));
    };
  };
}