...
function _default(key) {
  ...
  var prepare = function prepare() {
    ...
    _this.config = _objectSpread({}, settings);
  };
  ...
  this[_symbols.symModelCreate] = function () {
    ...
    prepare();
    var dev = development ? _this.config.dev : false; // ====================================== //
    ...
    states.onListen = function (key, payload) {
      ...
      try {
        for (var _iterator = subscribes.entries()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var subscribed = _step.value;

          subscribed[1][_symbols.symSubscriberGenerate](key, payload, states.values(), states.toMethod());
        }
      } catch (err) {
    ...
    function () {
      ...
      _regenerator["default"].mark(function _callee6(payload, headerDispatcher, actions) {
        var components, _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, _step2$value, _key2, subscribed, allModels, models, _key, header;
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                ...
                for (_iterator2 = subscribes.entries()[Symbol.iterator](); !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                  _step2$value = (0, _slicedToArray2["default"])(_step2.value, 2), _key2 = _step2$value[0], subscribed = _step2$value[1];
                  components[_key2] = {
              ...
              case 20:
                allModels = _index["default"].model.all(_this.key);
                models = {};

                for (_key in allModels) {
                  models[_key] = {};

                  if (allModels[_key].config.publicStates) {
                    models[_key].states = allModels[_key].states;
                  }

                  if (allModels[_key].config.publicDispatchers) {
                    models[_key].dispatchers = allModels[_key].dispatchers;
                  }
                } // ====================================== //
  ...
  this.subscribe = function (subscriber) {
    ...
    subscriber[_symbols.symSubscriberInit](states.values(), states.toMethod());
