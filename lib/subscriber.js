...
Subscriber.prototype[_symbols.symSubscriberInit] = function (allStates, allStatesToMethod) {
  var statesDefined = this[_symbols.symSubscriberMapStateToProps](allStates, allStatesToMethod);
...
Subscriber.prototype[_symbols.symSubscriberGenerate] = function (keyState, nextPayloadState, allStates, allStatesToMethod) {
  var statesDefined = this[_symbols.symSubscriberMapStateToProps](_objectSpread({}, allStates, (0, _defineProperty2["default"])({}, keyState, nextPayloadState)), allStatesToMethod);
